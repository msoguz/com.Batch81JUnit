...
public class C02_WriteExcel {
    ...
    @Test
    public void writeExcelCell() throws IOException {
        ...
        FileOutputStream fos=new FileOutputStream(dosyaYolu);//Excel dosyamiza veri girisi yaptiktan sonra
                                                            // dosyayi akisa aldigimiz gibi sonlandirmamiz gerekir.
                                                            //Sonrasinda da workbook objemize kayit etmemiz gerekir.
        workbook.write(fos);//write() method'u ile sonlandirdigimiz islemi workbook'a yazdirdik.
